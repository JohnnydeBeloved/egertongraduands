					...
					<div class="row">
						<div class="col-md-12" style="margin-left:10px">
							...
							<div class="row">
								...
								<ol>
									<?php
									$sql = "SELECT * FROM requirement NATURAL JOIN designee WHERE staff_id = 14";
									$query = $conn->prepare($sql);
									$query->execute();
									$fetch = $query->fetchAll();
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										NATURAL JOIN requirement WHERE staff_id = 14 AND id = $userid ";
										$query = $conn->prepare($sql);
										$query->execute();
										$fetch = $query->fetchAll();
