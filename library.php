			...
			<div class="top_nav">
				...
				<li role="presentation" class="dropdown">
					...
					<ul id="menu1" class="dropdown-menu list-unstyled msg_list" role="menu">
						...
						<?php
						$userid = $_SESSION['id'];
						$sql = "SELECT * FROM message LEFT JOIN designee ON staff.staff_id = message.staff_id 
						WHERE id = $userid ";
					...
					<div class="row">
						<div class="col-md-12" style="margin-left:10px">
							...
							<div class="row">
								...
								<ol>
									<?php
									$sql = "SELECT * FROM requirement NATURAL JOIN staff WHERE staff_id = 8";
									$query = $conn->prepare($sql);
									$query->execute();
									$fetch = $query->fetchAll();
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										NATURAL JOIN requirement WHERE staff_id = 8 AND id = $userid ";
										$query = $conn->prepare($sql);
										$query->execute();
										$fetch = $query->fetchAll();
