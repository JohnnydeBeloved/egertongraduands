			...
			<div class="col-md-3 left_col menu_fixed">
				<div class="left_col scroll-view">
					<div class="navbar nav_title" style="border: 0;">
						<a href="admin.php" class="site_title"><i class="fa fa-heart"></i> <span>Egerton Graduands</span></a>
					</div>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="">
								<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<img src="..\img\paul-pogba.jpg" alt=""><?php echo "$name"; ?>
						...
						<div class="x_panel">
							...
							<div class="x_content">
								<table id="datatable-buttons" class="table table-hover table-bordered">
									...
									<tbody>
										<?php
										$sql = "SELECT * FROM graduand WHERE status = 0";
