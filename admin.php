 ...
 <head>
 	...
 	<title>Egerton University Graduands</title>
 	...
 	<!-- icon -->
 	<link rel="icon" href="../images/EU-logo.jpg" >
 </head>
 			...
 			<div class="col-md-3 left_col menu_fixed">
 				<div class="left_col scroll-view">
 					<div class="navbar nav_title" style="border: 0;">
 						<a href="#" class="site_title"><i class="fa fa-heart"></i> <span>Egerton Graduands</span></a>
 					</div>
 					...
 					<div class="profile">
 						<div class="profile_pic">
 							<img src="..\img\paul-pogba.jpg" alt="..." class="img-circle profile_img">
 						</div>
 					...
 					<div class="page-title">
 						...
 						<div class="title_right">
 							<button class="btn btn-primary btn-md pull-right" data-toggle="modal" data-target="#myModal">
 								<i class="fa fa-plus"></i> Add Graduand
 							</button>
 							<?php include '../modal_addgraduand.php'; ?>
 						</div>
 					</div>
 					<div class="clearfix"></div>
 					<div class="row">
 							...
 							<div class="x_panel">
 								...
 								<div class="col-md-4 col-sm-4 col-xs-12">
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										<div class="x_title">
 											<h2>Faculty of Education and Community Studies</h2>
 											<div class="clearfix"></div>
 										</div>
 										<div class="x_content">
 											<div class="row">
 												<p>Total Number of Graduands: 								
 													<?php
 													$sql = "SELECT * FROM graduand WHERE Department = 'FEDCOS' ";
 											...
 											<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-FEDCOS" >View List</button>
 											<!-- Modal FEDCOS -->
 											<div class="modal fade" id="modal-FEDCOS">
 												<div class="modal-dialog modal-lg">
 													<div class="modal-content">
 														<!-- modal header -->
 														<div class="modal-header">
 															<button type="button" class="close" data-dismiss="modal">&times;</button>
 															<h3>List of Graduands in the Faculty</h3>
 														</div>
 														<!-- modal body -->
 															...
 															<table id="datatable-buttons" class="table table-hover table-bordered" style="width:100%;">
 																...
 																<tbody>
 																	...
 																	<tr>
 																		...
 																		<td>
 																			<a href = "..\delete_graduand.php?id=<?php echo $value ['id']?>" class = "btn btn-danger btn-xs"><i class = "fa 	fa-trash"></i> Delete</a>
 									...
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										...
 										<div class="x_content">
 											<div class="row">
 												<p>Total Number of Graduands: 								
 													<?php
 													$sql = "SELECT * FROM graduand WHERE Department = 'FOS' ";
 													$query = $conn->query($sql);
 													$count = $query->rowCount();
 													echo $count;
 													?>
 											...
 											<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-FOS" >View List</button>
 											<!-- Modal FOS -->
 											<div class="modal fade" id="modal-FOS">
 												<div class="modal-dialog modal-lg">
 													<div class="modal-content">
 														<!-- modal header -->
 														<div class="modal-header">
 															<button type="button" class="close" data-dismiss="modal">&times;</button>
 															<h3>List of Graduands in Faculty of Sciences</h3>
 														</div>
 														<!-- modal body -->
 														<div class="modal-body">
 																...
 																<tbody>
 																	...
 																	<tr>
 																		...
 																		<td class = "center" style = "text-align:center;">
 																			<a href = "..\delete_graduand1.php?id=<?php echo $value ['id']?>" class = "btn btn-danger btn-xs"><i class = "fa fa-trash"></i> Delete</a>
 																			<a href = "#edit<?php echo $value ['id']?>" data-toggle="modal" class = "btn btn-success btn-xs"><i class = "fa fa-pencil"></i> Edit</a>
 																		</td> 																	
 																		<?php include '../modal_edit.php';?>		
 																	</tr>														
 										...
 										<div class="x_content">
 											<div class="row">
 												<p>Total Number of Faculty: 								
 													<?php
 													$sql = "SELECT * FROM graduand WHERE Department = 'FASS' ";
 													$query = $conn->query($sql);
 													$count = $query->rowCount();
 													echo $count;
 													?>		
 											...
 											<div class="row">
 												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-FASS" >View List</button>
 												<!-- Modal FASS -->
 												<div class="modal fade" id="modal-FASS">
 													<div class="modal-dialog modal-lg">
 														<div class="modal-content">
 															<!-- modal header -->
 															<div class="modal-header">
 																<button type="button" class="close" data-dismiss="modal">&times;</button>
 																<h3>List of Graduands in Faculty of Arts and Social Sciences</h3>
 															</div>
 															<!-- modal body -->
 															<div class="modal-body">
 																<table id="datatable-buttons" class="table table-hover table-bordered" style="width:100%;">
 								...
 								<div class="col-md-4 col-sm-4 col-xs-12">
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										...
 										<div class="x_content">
 											<p>Total Number of Graduands: 								
 												<?php
 												$sql = "SELECT * FROM graduand WHERE Department = 'FOA' ";
 												$query = $conn->query($sql);
 												$count = $query->rowCount();
 												echo $count;
 												?>		
 											...
 											<div class="row">
 												...
 												<!-- Modal FOA -->
 												<div class="modal fade" id="modal-FOA">
 													<div class="modal-dialog modal-lg">
 														<div class="modal-content">
 															<!-- modal header -->
 															<div class="modal-header">
 																<button type="button" class="close" data-dismiss="modal">&times;</button>
 																<h3>List of Graduand in Faculty of Agriculture</h3>
 															</div>
 															<!-- modal body -->
 															<div class="modal-body">
 																<table id="datatable-buttons" class="table table-hover table-bordered" style="width:100%;">
 								...
 								<div class="col-md-4 col-sm-4 col-xs-12">
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										...
 										<div class="x_content">
 											<p>Total Number of Graduands: 								
 												<?php
 												$sql = "SELECT * FROM graduand WHERE Department = 'FET' ";
 												$query = $conn->query($sql);
 												$count = $query->rowCount();
 												echo $count;
 												?>		
 											...
 											<div class="row">
 												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-FET" >View List</button>
 												<!-- Modal FET -->
 												<div class="modal fade" id="modal-FET">
 													<div class="modal-dialog modal-lg">
 														<div class="modal-content">
 															<!-- modal header -->
 															<div class="modal-header">
 																<button type="button" class="close" data-dismiss="modal">&times;</button>
 																<h3>List of Graduands in Faculty of Engineering</h3>
 															</div>
 															<!-- modal body -->
 															<div class="modal-body">
 																<table id="datatable-buttons" class="table table-hover table-bordered" style="width:100%;">
 								...
 								<div class="col-md-4 col-sm-4 col-xs-12">
 									<div class="x_panel tile fixed_height_320 overflow_hidden">
 										...
 										<div class="x_content">
 											<p>Total Number of Graduands: 								
 												<?php
 												$sql = "SELECT * FROM graduand WHERE Department = 'FOHS' ";
 												$query = $conn->query($sql);
 												$count = $query->rowCount();
 												echo $count;
 												?>		
 											...
 											<div class="row">
 												<button type="button" class="btn btn-primary" data-toggle="modal" data-target="#modal-FOHS" >View List</button>
 												<!-- Modal FOHS -->
 												<div class="modal fade" id="modal-FOHS">
 													<div class="modal-dialog modal-lg">
 														<div class="modal-content">
 															<!-- modal header -->
 															<div class="modal-header">
 																<button type="button" class="close" data-dismiss="modal">&times;</button>
 																<h3>List of Graduands in Faculty of Health Sciences</h3>
 															</div>
 															<!-- modal body -->
 															<div class="modal-body">
 																<table id="datatable-buttons" class="table table-hover table-bordered" style="width:100%;">
