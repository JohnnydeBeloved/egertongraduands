				...
				<div class="left_col scroll-view">
					...
					<div class="profile">
						<div class="profile_pic">
							<img src="images/paul-pogba.jpg" alt="..." class="img-circle profile_img">
						</div>
						...
						<ul class="nav navbar-nav navbar-right">
							<li class="">
								<a href="javascript:;" class="user-profile dropdown-toggle" data-toggle="dropdown" aria-expanded="false">
									<img src="images/paul-pogba.jpg" alt=""><?php echo $name_staff; ?>
				...
				<div class="">
					<div class="page-title">
						<div class="title_left">
							<h3><a href="staff.php"> <i class="fa fa-arrow-left"></i> Back</a></h3>
						</div>
							...
							<div class="x_content col-md-12" >
								<table class="table table-hover table-bordered">
									...
									<tbody>
										...
										$a = $_POST['haydi'];
										$user_id = $_SESSION['id'];
										$sql = "SELECT * FROM requirement NATURAL JOIN requirementstatus WHERE staff_id = $user_id AND id = $a ";
										$query = $conn->prepare($sql);
										$query->execute();
