				...
				<div class="">
					<div class="page-title">
						...
						<div class="title_right">				
							...
							<?php include '../modal_addgraduand1.php'; ?>
						</div>
					</div>
					...
					<div class="col-md-12 col-sm-12 col-xs-12">
						<div class="x_panel">
							<div class="x_title">
								<h2>List of all cleared graduands</h2>
								<div class="clearfix"></div>
							</div>
							<div class="x_content">
								<table id="datatable-buttons" class="table table-hover table-bordered">
									...
									<tbody>
										<?php
										$sql = "SELECT * FROM graduand NATURAL JOIN cleared_graduand";
				...
				<form method="post" action="save_deadline">
					...
					<div class="modal-body">
						...
						if  ($fetch['status'] == 0){
							...
							?>
							<a href="javascript" class="reset_dl">Click here to reset the deadline</a>
							<?php	}
							?>
						</div>
