	...
	<nav class="navbar navbar-default">
		<div class="container-fluid">
			...
			<div class="navbar-header">
				...
				<a class="navbar-brand" href="#">Egerton Graduands</a>
			</div>
	...
	<div class="container">
			...
			<div id="myCarousel" class="carousel slide" data-ride="carousel" style="padding:20px 20px 20px 20px;">
				...
				<div class="carousel-inner" role="listbox">
					<div class="item active">
						<img src="images/EGERTON-UNI.jpg" alt="Chania" width="460" height="200">
					</div>

					<div class="item">
						<img src="images/EGERTON-PIC.jpg" alt="Chania" width="460" height="200">
					</div>

					<div class="item">
						<img src="images/undergrad 1_0.jpg" alt="Flower" width="460" height="200">
					</div>

					<div class="item">
						<img src="images/courpic.jpg" alt="Flower" width="460" height="200">
					</div>
				</div>
		...
		<div class="row"> 
			<div class="col-md-5 mv">
				...
				<p>To offer exemplary education to society and generate knowledge for national and global development.</p>
			</div>
			<div class="col-md-5 mv">
				<center><h3>Vision</h3></center>
				<p>To be  a world class university for the advancement of humanity.</p>
				</div>
			</div>
		</div>
