					...
					<div class="row">
						<div class="col-md-12" style="margin-left:10px">
							...
							<div class="row">
								...
								<ol>
									<?php
									$sql = "SELECT * FROM requirement NATURAL JOIN staff WHERE designee_id = 9";
									$query = $conn->prepare($sql);
									$query->execute();
									$fetch = $query->fetchAll();
								...
								if(isset($_POST['files']))
								{
									...
									if($sql1){ 													
										echo '
										<script> 														
											window.location = "graduand_passrequirements.php"
										</script>'; 												
									}
								}
								?>
								<table class="table table-bordered">
									...
									<tbody>
										...
										NATURAL JOIN requirement WHERE staff_id = 9 AND id = $userid ";
										$query = $conn->prepare($sql);
										$query->execute();
										$fetch = $query->fetchAll();
